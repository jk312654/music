...
public class MusicCardAdapter extends BaseQuickAdapter<MusicInfo, BaseViewHolder> {
    String newCoverUrl;
    ...
    public MusicCardAdapter(List<MusicInfo> data) {
        super(R.layout.item_music_card, data);
    }
    ...
    protected void convert(BaseViewHolder helper, MusicInfo item) {
        ...
        Log.d("MusicCardAdapter", "加载图片: " + newCoverUrl);
